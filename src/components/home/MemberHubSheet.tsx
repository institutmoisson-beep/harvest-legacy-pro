...
const items = (logged: boolean) => [
  ...
  { to: '/grenier', label: 'Le Grenier (Invest.)', icon: Wheat, color: 'from-amber-600 to-yellow-700' },
  { to: '/ma-carte', label: 'Ma Carte Moissonneur', icon: IdCard, color: 'from-yellow-500 to-amber-600' },
  { to: '/verifier', label: 'Vérifier un membre', icon: ScanLine, color: 'from-emerald-500 to-teal-600' },
