...
CREATE OR REPLACE FUNCTION public.moisson_invest_in_project(p_project_id uuid, p_shares integer, p_payment_method text DEFAULT 'wallet'::text)
...
BEGIN
  ...
  VALUES (v_user_id, NULL, v_total, 'investment', 'completed', 'Achat de ' || p_shares || ' part(s) — projet Grenier');
